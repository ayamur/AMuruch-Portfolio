    ...
    <>
      ...
      <div class='home-all'>
        <div class='home'>
          ...
          <h3>-|- React -|- CSS -|- HTML -|- JavaScript -|- TypeScript -|- JSON -|- JSX -|- AJAX -|- EJS -|-  MongoDB -|- Mongoose -|- Node -|- NPM -|- MERN Stack -|- TypeScript -|- Sequelize -|- PostGRE SQL -|- jQuery -|- Bootstrap -|- Express.js -|- APIs -|- MEN stack -|- JSX -|- SPAs -|- MVC -|- RESTful Routing -|- bit.io -|- GitHub -|- JWTs -|- GoogleOAuth -|-</h3>
          <h4>Currently Looking For: A Remote Junior Development Position in an Educational and Creative Environment where my Ideas, Enthusiasm, and Excitability can make a Positive Difference.</h4>
