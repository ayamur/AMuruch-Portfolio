    ...
    <>
      <div class='home-all'>
        <div class='home'>
          ...
          <div>
          <h3>Languages: <div id='javascript' className='listicons' ><img src='https://raw.githubusercontent.com/tandpfun/skill-icons/59059d9d1a2c092696dc66e00931cc1181a4ce1f/icons/JavaScript.svg' alt='JavaScript icon'/>JavaScript </div>, HTML, CSS, TypeScript, EJS</h3></div>
          <h3>Web Application Stacks: MERN, PERN</h3>
          <h3>Database/ Backend: PostgreSQL, <div id='mondodb' className='listicons'><img src='https://raw.githubusercontent.com/tandpfun/skill-icons/59059d9d1a2c092696dc66e00931cc1181a4ce1f/icons/MongoDB.svg' alt='mondoDB icon' />(MongoDB)</div>, <div id='expressjs'className='listicons'><img src='https://raw.githubusercontent.com/tandpfun/skill-icons/59059d9d1a2c092696dc66e00931cc1181a4ce1f/icons/ExpressJS-Dark.svg' alt='express.js icon'/>(Express.js) <div icon='nodejs'><img src='https://raw.githubusercontent.com/tandpfun/skill-icons/59059d9d1a2c092696dc66e00931cc1181a4ce1f/icons/NodeJS-Dark.svg' alt='node.js icon'/>(Node.js)</div></div></h3>
