  ...
  return (
    ...
    <>
      ...
      <h1> Ayala Murúch </h1>
          ...
          <h2>Software Engineer with a Background in Design, Non-Profits, and Game Testing. Passionate about Coding, Uplifting Others, and Everything Paranormal! </h2>
          ...
          <h2>Currently Looking For: A Remote Junior Software or Web Develpoment Position in an Educational and Creative Environment where my Ideas, Enthusiasm, and Excitability can make a Positive Difference!</h2>
