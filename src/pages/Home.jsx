    ...
    <>
      <div class='home-all'>
        <div class='home'>
          ...
          <div>
          <h3>Languages: <div id='javascript' className='listicons' ><img src='https://raw.githubusercontent.com/tandpfun/skill-icons/59059d9d1a2c092696dc66e00931cc1181a4ce1f/icons/JavaScript.svg' alt='JavaScript icon'/>(JavaScript) </div>, HTML, CSS, <div id='typescript' className='listicons' ><img src='https://raw.githubusercontent.com/tandpfun/skill-icons/59059d9d1a2c092696dc66e00931cc1181a4ce1f/icons/TypeScript.svg' alt='TypeScript icon'/>(TypeScript) </div>, EJS</h3></div>
          <h3>Web Application Stacks: MERN, PERN</h3>
          <h3>Database/ Backend: <div id='postgresql' className='listicons'><img src='https://raw.githubusercontent.com/tandpfun/skill-icons/59059d9d1a2c092696dc66e00931cc1181a4ce1f/icons/PostgreSQL-Dark.svg' alt='PostgreSQL icon' />(PostgreSQL)</div>PostgreSQL, <div id='mondodb' className='listicons'><img src='https://raw.githubusercontent.com/tandpfun/skill-icons/59059d9d1a2c092696dc66e00931cc1181a4ce1f/icons/MongoDB.svg' alt='mondoDB icon' />(MongoDB)</div>, <div id='expressjs'className='listicons'><img src='https://raw.githubusercontent.com/tandpfun/skill-icons/59059d9d1a2c092696dc66e00931cc1181a4ce1f/icons/ExpressJS-Dark.svg' alt='express.js icon'/>(Express.js) </div><div icon='nodejs'><img src='https://raw.githubusercontent.com/tandpfun/skill-icons/59059d9d1a2c092696dc66e00931cc1181a4ce1f/icons/NodeJS-Dark.svg' alt='node.js icon'/>(Node.js)</div></h3>
          <h3>Software Development Platforms: GitHub, </h3>
          <h3>Additional: RESTful Routing, APIs, Mongoose ODM, JSON, JWT, AJAX, <div icon='sequelize'><img src='https://raw.githubusercontent.com/tandpfun/skill-icons/59059d9d1a2c092696dc66e00931cc1181a4ce1f/icons/Sequelize-Dark.svg' alt='Sequelize icon'/>(Sequelize)</div>, SPA, MVC framework, bit.io, OAuth, VS Code, Postman </h3>
