  ...
  return (
    <>
      <div>
        ...
        <h4>Currently Looking For: Remote Junior Development Position in an Educational and Creative Environment Where My Ideas,Enthusiasm, and Excitability Can Make a Positive Difference.</h4>
