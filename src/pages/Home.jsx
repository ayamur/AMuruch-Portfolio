  ...
  return (
    ...
    <>
      ...
      <h1> Ayala Murúch </h1>
          ...
          <h3>Tech React -|- CSS -|- HTML -|- JavaScript -|- TypeScript -|- JSON -|- JSX -|- AJAX -|- EJS -|-  MongoDB -|- Mongoose -|- Node -|- NPM -|- MERN Stack -|- Sequelize -|- PostGRE SQL -|- jQuery -|- Bootstrap -|- Express.js -|- APIs -|- MEN stack -|- JSX -|- SPAs -|- MVC -|- RESTful Routing -|- bit.io -|- GitHub -|- JWTs -|- GoogleOAuth -|-</h3>
          <h2>Currently Looking For: A Remote Junior Software or Web Development Position in an Educational and Creative Environment where my Ideas, Enthusiasm, and Excitability can make a Positive Difference!</h2>
