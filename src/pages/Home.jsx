    ...
    <>
      <div class='home-all'>
        <div class='home'>
          ...
          <h3>Additional:</h3><h6> RESTful Routing, <div icon='api'>
              <img src='/techicons/api.png' alt='API icon' className='listicons' />
              (Sequelize)
            </div>, Mongoose ODM, JSON, JWT, AJAX
            <div icon='sequelize'>
              ...
              (Sequelize)
            </div> SPA, MVC framework, bit.io, OAuth <div icon='postman'>
